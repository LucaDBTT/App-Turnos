...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <asp:GridView ID="dgvMedicoPorEspecialidad" runat="server" AutoGenerateColumns="False" DataKeyNames="idMedicoPorEspecialidad" 
            CssClass="gridview-style" AllowPaging="true" PageSize="10" OnPageIndexChanging="dgvMedicoPorEspecialidad_PageIndexChanging" >
           <RowStyle CssClass="gridview-row" />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Sacar Turno">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkTurno" runat="server" Text="Quiero mi turno!" CommandName="Turno" CommandArgument='<%# Eval("idMedicoPorEspecialidad") %>'  CssClass="eliminar-button" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
